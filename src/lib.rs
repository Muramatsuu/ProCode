...
#[derive(Debug)]
pub struct ProCodeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ProCodeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ProCode processing");
    
    let mut processor = ProCodeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ProCodeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ProCodeProcessor::new(false);
